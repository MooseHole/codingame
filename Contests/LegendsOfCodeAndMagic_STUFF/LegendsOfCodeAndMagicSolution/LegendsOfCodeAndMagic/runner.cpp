...
void start()
{
	...
	outputFile << "Minimum " << LETHAL_SCORE_MIN << " " << ATTACK_SCORE_MIN << " " << BREAKTHROUGH_SCORE_MIN << " " << CHARGE_SCORE_MIN << " " << DRAIN_SCORE_MIN << " " << GUARD_SCORE_MIN << " " << GUARD_AND_WARD_SCORE_MIN << " " << WARD_SCORE_MIN << " " << HEAL_ME_SCORE_MIN << " " << DAMAGE_THEM_SCORE_MIN << " " << DRAW_SCORE_MIN << " " << PLAYER_HEALTH_SCORE_MIN << " " << PLAYER_GUARD_SCORE_MIN << " " << PLAYER_ATTACK_SCORE_MIN << " " << PLAYER_DRAW_SCORE_MIN << endl;
	outputFile << "Maximum " << LETHAL_SCORE_MAX << " " << ATTACK_SCORE_MAX << " " << BREAKTHROUGH_SCORE_MAX << " " << CHARGE_SCORE_MAX << " " << DRAIN_SCORE_MAX << " " << GUARD_SCORE_MAX << " " << GUARD_AND_WARD_SCORE_MAX << " " << WARD_SCORE_MAX << " " << HEAL_ME_SCORE_MAX << " " << DAMAGE_THEM_SCORE_MAX << " " << DRAW_SCORE_MAX << " " << PLAYER_HEALTH_SCORE_MAX << " " << PLAYER_GUARD_SCORE_MAX << " " << PLAYER_ATTACK_SCORE_MAX << " " << PLAYER_DRAW_SCORE_MAX << endl;
	outputFile.close();
}
